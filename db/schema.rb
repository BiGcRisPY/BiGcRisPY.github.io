...
ActiveRecord::Schema.define(version: 20170825220532) do
  ...
  create_table "learnedmoves", force: :cascade do |t|
  ...
  create_table "learnedtms", force: :cascade do |t|
    t.integer  "pokemon_id"
    t.integer  "tm_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "mytms", force: :cascade do |t|
    t.integer  "tm_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
